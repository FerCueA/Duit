...
public class ValoracionDAO {
    ...
    // MAPEO DE RESULTSET A VALORACION
    ...
    // OBTENER VALORACIONES POR TRABAJO
    ...
    public void insertarValoracion(Valoracion valoracion) throws SQLException {
        ...
        if (!objMySQLConnection.isError()) {
            String sql = String.format(
                    ...
                    valoracion.getIdTrabajo(), valoracion.getIdEmisor(), valoracion.getIdReceptor(),
                    valoracion.getTipo(), valoracion.getPuntuacion(), valoracion.getComentario(),
    ...
    public void actualizarValoracion(Valoracion valoracion) throws SQLException {
        ...
        if (!objMySQLConnection.isError()) {
            String sql = String.format(
                    ...
                    valoracion.getIdTrabajo(), valoracion.getIdEmisor(), valoracion.getIdReceptor(),
                    valoracion.getTipo(), valoracion.getPuntuacion(), valoracion.getComentario(),
                    valoracion.getFechaValoracion(), valoracion.getIdValoracion());
