...
public class EditProfileDTO {
    ...
    @NotBlank(message = "El nombre es obligatorio", groups = { UserProfileGroup.class, ProfessionalProfileGroup.class })
    ...
    @NotBlank(message = "La ciudad es obligatoria", groups = { UserProfileGroup.class, ProfessionalProfileGroup.class })
    ...
    @NotBlank(message = "El país es obligatorio", groups = { UserProfileGroup.class, ProfessionalProfileGroup.class })
